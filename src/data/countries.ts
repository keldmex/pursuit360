// ISO 3166-1 Country Data — sourced from official ISO standard
// 249 countries/territories

export interface Country {
  name: string
  alpha2: string  // e.g. "GB"
  alpha3: string  // e.g. "GBR"
  numeric: string // e.g. "826"
}
...
export const COUNTRIES: Country[] = [
  ...
  {"name":"Congo, DR","alpha2":"CD","alpha3":"COD","numeric":"180"},
...
// Quick lookups
export const countryByAlpha2 = Object.fromEntries(COUNTRIES.map(c => [c.alpha2, c]))
export const countryByAlpha3 = Object.fromEntries(COUNTRIES.map(c => [c.alpha3, c]))
export const countryNames = COUNTRIES.map(c => c.name).sort()
